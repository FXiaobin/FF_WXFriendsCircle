...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    FriendsCircleCell_01 *cell = [tableView dequeueReusableCellWithIdentifier:@"FriendsCircleCell_01" forIndexPath:indexPath];
...
-(UITableView *)tableView{
    if (_tableView == nil) {
        ...
        [_tableView registerClass:[FriendsCircleCell_01 class] forCellReuseIdentifier:@"FriendsCircleCell_01"];
